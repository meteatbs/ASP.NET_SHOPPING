<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlaceOrder.aspx.cs" Inherits="Demo_shoppingSite.PlaceOrder" %>
...
<body>
    ...
    <td colspan="2" align="center">
        <asp:Image ID="Image1" runat="server" BorderColor="Black" 
            ImageUrl="~/Images/creditcardoptions.png" Width="438px" 
            BorderWidth="2px" />
    </td>
