<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="UpdateProduct.aspx.cs" Inherits="Demo_shoppingSite.UpdateProduct" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Description">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Eval("Pdesc") %>' 
            ...
            <asp:TemplateField HeaderText="Category">
                <EditItemTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:AnilConnectionString %>" 
                        SelectCommand="SELECT [Pcategory] FROM [Product1]"></asp:SqlDataSource>
